            ...
            <div className="container-fluid py-5">
                <div className="container-fluid row">
                    <div className="container-fluid col-md-12 text-center">
                        ...
                        <Link to={"/"} className="btn fondoVerde">Volver a la Página Principal</Link>
                    </div>
                </div>
            </div>
        )
            ...
            <div className="row">
                <div className="col-md-12">
                    <table className="table">
                        <thead>
                            <tr>
                                <th scope="col" className="text-end" colSpan={5}><Link onClick={clear} className="btn fondoVerde" title="Vaciar Carrito">Vaciar Carrito</Link></th>
                            </tr>
                            <tr>
                                <th scope="col">&nbsp;</th>
                        ...
                        <tbody className="container-fluid">
                            ...
                            <tr>
                                ...
                                <td className="text-end"><Link to={"/checkout"} className="btn fondoVerde" title="Finalizar Compra">Finalizar Compra</Link></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
